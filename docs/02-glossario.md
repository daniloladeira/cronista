...
**Worker**: Processo separado da API que executa a transcrição. Consome trabalho lendo o estado das reuniões no banco, que funciona como a fila. Roda apartado porque mantém o modelo carregado em memória de vídeo. Ver [07-arquitetura.md](07-arquitetura.md).
